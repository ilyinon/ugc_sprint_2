...
| номер запроса | соотношение   |
| ------------- | ------------- |
|#1 | MongoDB медленнее примерно в 6,46 раза.|
|#2 | MongoDB медленнее примерно в 3,62 раза.|
|#3 |  MongoDB медленнее примерно в 1,05 раза.|
|#4 | MongoDB медленнее примерно в 11,2 раза.|
|#5 | MongoDB медленнее примерно в 1,25 раза.|
